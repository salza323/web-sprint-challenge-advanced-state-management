...
<!-- Makes it to where the developer can handle state within a certain bramch as opposed to globally.  -->
2. In your own words, describe `actions`, `reducers` and the `store` and their role in Redux. What does each piece do? Why is the store known as a 'single source of truth' in a redux application?
<!-- Actions- payloads of information
Reducers- function that takes previous state and returns mext state
Store- Where actions and reducers are stored.  -->
3. What is the difference between Application state and Component state? When would be a good time to use one over the other?
<!-- Application is global and component is local. Depends on what you want handled where. In the whole application or just in one specific component.  -->
4. Describe `redux-thunk`, what does it allow us to do? How does it change our `action-creators`?
<!-- Thunk is a middleware system that allows us to return functions from our action creators.  -->
5. What is your favorite state management system you've learned and this sprint? Please explain why!
<!-- Context, it is much less complicated and I wish we could have done our sprint challenge with context.  -->
